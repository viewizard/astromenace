...
public:
	...
	float	TrackRotationLastTime;// последнее время проворота, нет смысла постоянно менять геометрию, делаем это 30 раз в секунду только
	...
	int		*BarrelObject;
	float	BarrelRotationLastTime;// последнее время проворота, нет смысла постоянно менять геометрию, делаем это 30 раз в секунду только
