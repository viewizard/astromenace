...
void InformationObject3DText(int ObjectNum)
{
	...
	vw_DrawFont(SizeI, Y1-14, 0, 0, 1.0f, 1.0f,1.0f,1.0f, MenuContentTransp, GetText("3_GAME_OBJECTS_INFORMATION"));
...
void InformationMenu()
{
	...
	int	Size = vw_FontSize(GetText("3_Page_%i_of_%i"), CreateNum, InfoEnd);
	int SizeI = (Setup.iAspectRatioWidth-Size)/2;
	vw_DrawFont(SizeI, 50+30*16+15, 0, 0, 1.0f, 0.5f,0.5f,0.5f, 0.6f*MenuContentTransp, GetText("3_Page_%i_of_%i"), CreateNum, InfoEnd);
