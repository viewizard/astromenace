...
void DrawMenu()
{
	...
	// Copyright
	int CSize = vw_FontSize("%s © 2007-2014, Viewizard", vw_GetText("11_Copyright"));
	vw_DrawFont(Setup.iAspectRatioWidth-7-CSize, 740, 0, 0, 1.0f, 1.0f,1.0f,1.0f, 0.99f, "%s © 2007-2014, Viewizard", vw_GetText("11_Copyright"));
