...
missile:
		...
		case 214:
			...
			if (MineIData >= 0.1f)
			{
				if (TextureIllum[0] == 0) TextureIllum[0] = vw_FindTextureByName("models/mine/mine1i.tga");
		...
		case 215:
			...
			if (MineIData >= 0.1f)
			{
				if (TextureIllum[0] == 0) TextureIllum[0] = vw_FindTextureByName("models/mine/mine2i.tga");
				else TextureIllum[0] = 0;
				MineIData = 0.0f;
			}
			DrawObjectList[0].Rotation.y += 90.0f*TimeDelta;
		...
		case 216:
			...
			if (MineIData >= 0.1f)
			{
				if (TextureIllum[0] == 0) TextureIllum[0] = vw_FindTextureByName("models/mine/mine3i.tga");
				else TextureIllum[0] = 0;
				MineIData = 0.0f;
			}
		...
		case 217:
			...
			if (MineIData >= 0.1f)
			{
				if (TextureIllum[0] == 0) TextureIllum[0] = vw_FindTextureByName("models/mine/mine4i.tga");
				else TextureIllum[0] = 0;
				MineIData = 0.0f;
			}
			DrawObjectList[0].Rotation.y += 90.0f*TimeDelta;
