...
{
    if (SpaceShipNum <= 0 || static_cast<unsigned>(SpaceShipNum) > PresetAlienSpaceFighterData.size()) {
        std::cerr << __func__ << "(): "
    ...
    ArmorCurrentStatus = ArmorInitialStatus = PresetAlienSpaceFighterData[SpaceShipNum - 1].Armor / GameEnemyArmorPenalty;
