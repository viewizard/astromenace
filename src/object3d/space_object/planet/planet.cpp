...
void cPlanet::Create(int PlanetNum)
{
	...
	case 1:
		NeedCullFaces = false;
		NeedAlphaTest = true;
		LoadObjectData("models/planet/aplanet.vw3d", this, -1.0f, GameConfig().UseGLSL120);
	...
	case 3:
		NeedCullFaces = false;
		LoadObjectData("models/planet/gplanet.vw3d", this, -1.0f, GameConfig().UseGLSL120);
	...
	// "красная" планета
	case 4:
		LoadObjectData("models/planet/moon.vw3d", this, -1.0f, GameConfig().UseGLSL120);
	...
	case 5:
		LoadObjectData("models/planet/planet5.vw3d", this, -1.0f, GameConfig().UseGLSL120);
	...
	// планета пришельцев
	case 6:
		LoadObjectData("models/planet/planet6.vw3d", this, -1.0f, GameConfig().UseGLSL120);
		Texture[0] = vw_FindTextureByName("models/planet/d_class3.tga");
		TextureIllum[0] = 0;
		NormalMap[0] = vw_FindTextureByName("models/normalmap/d_class3_nm.tga");
		break;
