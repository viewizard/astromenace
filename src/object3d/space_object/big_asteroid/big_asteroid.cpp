...
void cBigAsteroid::Create(int AsteroidNum)
{
	...
	switch (AsteroidNum) {
	case 11:
		LoadObjectData("models/space/bigasteroid-01.vw3d", this, 0, -1.0f, GameConfig().UseGLSL120);
		goto case9next;
	case 12:
		LoadObjectData("models/space/bigasteroid-02.vw3d", this, 0, -1.0f, GameConfig().UseGLSL120);
		goto case9next;
	case 13:
		LoadObjectData("models/space/bigasteroid-03.vw3d", this, 0, -1.0f, GameConfig().UseGLSL120);
		goto case9next;
	case 14:
		LoadObjectData("models/space/bigasteroid-04.vw3d", this, 0, -1.0f, GameConfig().UseGLSL120);
		goto case9next;
	case 15:
		LoadObjectData("models/space/bigasteroid-05.vw3d", this, 0, -1.0f, GameConfig().UseGLSL120);
