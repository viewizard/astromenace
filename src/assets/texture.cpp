...
struct sTextureAsset {
	...
	explicit sTextureAsset(bool _Alpha, eAlphaCreateMode _AlphaMode,
...
std::unordered_map<std::string, sTextureAsset> TextureMap{
	{"menu/astromenace.tga",
					sTextureAsset{true, eAlphaCreateMode::EQUAL, eTextureWrapMode::CLAMP_TO_EDGE,
	...
	{"menu/button256_off.tga",
					sTextureAsset{true, eAlphaCreateMode::EQUAL, eTextureWrapMode::CLAMP_TO_EDGE,
						      eTextureBasicFilter::BILINEAR, false, false}},
	{"menu/blackpoint.tga",
					sTextureAsset{false, eAlphaCreateMode::EQUAL, eTextureWrapMode::CLAMP_TO_EDGE,
						      eTextureBasicFilter::BILINEAR, false, false}},
	{"menu/whitepoint.tga",
					sTextureAsset{false, eAlphaCreateMode::EQUAL, eTextureWrapMode::CLAMP_TO_EDGE,
						      eTextureBasicFilter::BILINEAR, false, false}},
	...
	{"skybox/1/skybox_back6.tga",
					sTextureAsset{false, eAlphaCreateMode::GREYSC, eTextureWrapMode::CLAMP_TO_EDGE,
						      eTextureBasicFilter::BILINEAR, false, false}},
