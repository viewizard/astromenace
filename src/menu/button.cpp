...
bool DrawButton384(int X, int Y, const char *Text, float Transp, float *ButTransp, float *Update)
{
	...
	vw_DrawTransparent(&DstRect, &SrcRect, vw_FindTextureByName("menu/button384_back.tga"), true, IntTransp);

	SrcRect(0,0,384,64 );
	// рисуем кнопку
	DstRect(X,Y,X+384,Y+64);
	if (!ON)
		vw_DrawTransparent(&DstRect, &SrcRect, vw_FindTextureByName("menu/button384_out.tga"), true, Transp);
	else
		vw_DrawTransparent(&DstRect, &SrcRect, vw_FindTextureByName("menu/button384_in.tga"), true, Transp);
...
bool DrawButton256(int X, int Y, const char *Text, float Transp, float *ButTransp, float *Update, bool Off)
{
	...
	if (Off || DragWeapon) {
		...
		vw_DrawTransparent(&DstRect, &SrcRect, vw_FindTextureByName("menu/button256_back.tga"), true, Transp);

		SrcRect(0,0,256,64 );
		DstRect(X,Y,X+256,Y+64);
		vw_DrawTransparent(&DstRect, &SrcRect, vw_FindTextureByName("menu/button256_off.tga"), true, Transp);
	...
	// рисуем тень
	DstRect(X-125+2,Y-16+2,X-125+512-2,Y-16+96-2);
	vw_DrawTransparent(&DstRect, &SrcRect, vw_FindTextureByName("menu/button256_back.tga"), true, IntTransp);

	SrcRect(0,0,256,64 );
	// рисуем кнопку
	DstRect(X,Y,X+256,Y+64);
	if (!ON)
		vw_DrawTransparent(&DstRect, &SrcRect, vw_FindTextureByName("menu/button256_out.tga"), true, Transp);
	else
		vw_DrawTransparent(&DstRect, &SrcRect, vw_FindTextureByName("menu/button256_in.tga"), true, Transp);
...
bool DrawButton200_2(int X, int Y, const char *Text, float Transp, bool Off)
{
	...
	if (!ON)
		vw_DrawTransparent(&DstRect, &SrcRect, vw_FindTextureByName("menu/button_dialog200_out.tga"), true, Transp);
	else
		vw_DrawTransparent(&DstRect, &SrcRect, vw_FindTextureByName("menu/button_dialog200_in.tga"), true, Transp);
...
bool DrawButton128_2(int X, int Y, const char *Text, float Transp, bool Off, bool SoundClick)
{
	...
	if (!ON)
		vw_DrawTransparent(&DstRect, &SrcRect, vw_FindTextureByName("menu/button_dialog128_out.tga"), true, Transp);
	else
		vw_DrawTransparent(&DstRect, &SrcRect, vw_FindTextureByName("menu/button_dialog128_in.tga"), true, Transp);
...
void DrawCheckBox(int X, int Y, bool *CheckBoxStatus, const char *Text, float Transp)
{
	...
	vw_DrawTransparent(&DstRect, &SrcRect, vw_FindTextureByName("menu/checkbox_main.tga"), true, Transp);
	if (*CheckBoxStatus)
		vw_DrawTransparent(&DstRect, &SrcRect, vw_FindTextureByName("menu/checkbox_in.tga"), true, Transp);
