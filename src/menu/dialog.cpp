...
bool DrawDialogButton200(int X, int Y, const char *Text, float Transp)
{
	...
	if (!ON)
		...
		vw_DrawTransparent(&DstRect, &SrcRect, vw_FindTextureByName("menu/button_dialog200_in.tga"), true, 0.8f*Transp);
...
bool DrawDialogButton128(int X, int Y, const char *Text, float Transp)
{
	...
	if (!ON)
		...
		vw_DrawTransparent(&DstRect, &SrcRect, vw_FindTextureByName("menu/button_dialog128_in.tga"), true, 0.8f*Transp);
