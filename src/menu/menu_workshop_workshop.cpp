...
eTexture * GetSystemIcon(int Num)
{
	switch (Num)
	{
		case -4:	return vw_FindTextureByName("menu/system_empty.tga");
		case -3:	return vw_FindTextureByName("menu/system_empty.tga");
		case -2:	return vw_FindTextureByName("menu/system_empty.tga");
		case -1:	return vw_FindTextureByName("menu/system_empty.tga");
		case 0:		return vw_FindTextureByName("menu/system_empty.tga");

		case 1:		return vw_FindTextureByName("menu/system_engine1.tga");
		case 2:		return vw_FindTextureByName("menu/system_engine2.tga");
		case 3:		return vw_FindTextureByName("menu/system_engine3.tga");
		case 4:		return vw_FindTextureByName("menu/system_engine4.tga");

		case 5:		return vw_FindTextureByName("menu/system_power1.tga");
		case 6:		return vw_FindTextureByName("menu/system_power2.tga");
		case 7:		return vw_FindTextureByName("menu/system_power3.tga");
		case 8:		return vw_FindTextureByName("menu/system_power4.tga");

		case 9:		return vw_FindTextureByName("menu/system_target1.tga");
		case 10:	return vw_FindTextureByName("menu/system_target2.tga");
		case 11:	return vw_FindTextureByName("menu/system_target3.tga");
		case 12:	return vw_FindTextureByName("menu/system_target4.tga");

		case 13:	return vw_FindTextureByName("menu/system_mechan1.tga");
		case 14:	return vw_FindTextureByName("menu/system_mechan2.tga");
		case 15:	return vw_FindTextureByName("menu/system_mechan3.tga");
		case 16:	return vw_FindTextureByName("menu/system_mechan4.tga");

		case 17:	return vw_FindTextureByName("menu/system_protect1.tga");
		case 18:	return vw_FindTextureByName("menu/system_protect2.tga");
		case 19:	return vw_FindTextureByName("menu/system_protect3.tga");
		case 20:	return vw_FindTextureByName("menu/system_protect4.tga");
